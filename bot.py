...
USERNAME = "dxorx898"
PASSWORD = "dxorx898"
#BOT_USERNAME = "Rishunumbot"
BOT_TOKEN = os.getenv("BOT_TOKEN", "8271410063:AAEJP7kaIljQ3XWWRDtGlbbJE9wW5OLez9A")
#DEVELOPER_ID = "@RISHIHEARTMAKER"
CHANNEL_LINK = "https://t.me/jndtech1"
...
async def send_telegram_message(current_time, country, number, sender, message):
    ...
    #    [InlineKeyboardButton("☘ 2nd Channel", url=f"https://t.me/")],
        [
        InlineKeyboardButton(f"🚀 Number Channel", url=f"https://t.me/freeotpss")
    ]
    ]
